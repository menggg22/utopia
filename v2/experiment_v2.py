"""
Experiment runner (v2) — run one or many v2 simulation configs sequentially.

Usage:
    python experiment_v2.py experiments/v2/baseline_seed0.json           # run one
    python experiment_v2.py experiments/v2/baseline_seed*.json           # run several
    python experiment_v2.py experiments/v2/                              # run all in dir
"""
...
import glob
import time
from simulate_v2 import run_simulation
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Run v2 experiment batch")
